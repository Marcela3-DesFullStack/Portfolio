...
const Home = () => {
  ...
  return (
    ...
    <div className="sm:h-[60vh] w-full h-[90vh] overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col sm:flex-row items-center justify-around bg-customCobalt">
        ...
        <div className="sm:top-[52%] sm:pl-0 sm:pr-[5%] sm:flex sm:flex-col sm:items-center sm:justify-center absolute left-[10%] top-[45%] text-customWhite">
            <p className="text-[25px] sm:text-[15px] ">Hi! I`m</p> 
            <p className="text-[45px] sm:text-[25px] l">Marcela Niño</p>
            <p className="text-[25px] sm:text-[14px] ">Engineer and Full Stack Web Junior Developer</p>   
        </div>
    </div>
