...
const Home = () => {
  ...
  return (
    ...
    <div className="sm:h-[80vh] w-full h-[70vh] overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col sm:flex-row items-center justify-around bg-customCobalt sm:h-[50vh]">
